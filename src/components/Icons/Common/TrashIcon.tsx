...
// Not my favorite way of doing this. You can see I took out your hardcoded stuff. Now I can use css
// See https://icomoon.io/app/#/select for a better approach for the web
const TrashIcon = () => (
  <svg
